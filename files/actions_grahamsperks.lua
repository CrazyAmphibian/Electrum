...
table.insert( actions,
{
	...
	custom_xml_file = "mods/Electrum/files/actions_grahamsperks/balloon_summon_card.xml",
...
table.insert( actions,
{
	...
	custom_xml_file = "mods/Electrum/files/actions_grahamsperks/balloon_fill_card.xml",
	type 		= ACTION_TYPE_OTHER,
